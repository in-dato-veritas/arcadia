...
* **SEEMPLR** will be responsible of experimenting with tools that ARCADIA will make available. At some point, SEEMPLR should be a profitable business, providing services for the new digital economy for personal data, and proving that is not only possible but that it has also be sustainable in economic terms.
...
1. **USERS**. They decide to upload data to ARCADIA. They want to control and learn from their data but generally don't know how to it. They might decide to share their data with others if the incentives are there. They shouldn't be paying for controlling their data warehouse.
...
2.1. From raw data to personality
2.2. Data visualisation
2.3. Data do not leave your profile
3. **The knowledge machine**
3.1. Players, roles, and interactions
3.2. Working with personal data
3.3. Characteristics as building blocks
3.4. The ground truth
4. **The foundations of the underlying economics**
4.1. Why using cryptocurrencies?
4.2. Quality over quantity
4.3. Put a price on your data
